...
/** Tab labels */
export const TAB_SCOREBOARD = 'النتائج';
export const TAB_ROTATION = 'الدوران';
export const TAB_LEADERBOARD = 'المتصدرين';

/** Button labels */
export const BTN_NEW_DEAL = 'صكة جديدة';
export const BTN_ADD_TEAM = 'إضافة فريق';
export const BTN_RESET = 'إعادة تعيين';
...
export const PLACEHOLDER_PLAYER2 = 'اسم اللاعب الثاني';

/** Match history */
export const MATCH_HISTORY_TITLE = 'سجل المباريات';
